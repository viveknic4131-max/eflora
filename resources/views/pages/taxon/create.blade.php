                        ...
                        <div class="card-body px-0 pb-2 px-5">
                            <form action="{{ route('taxon.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group input-group-outline my-3">
                                            <label class="form-label">Is Excluded Taxon *</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group input-group-outline my-3">
                                            <label class="form-label">Is Cultivated Taxon *</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group input-group-outline my-3">
                                            <label class="form-label">Is Introduced Taxon *</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group input-group-outline my-3">
                                            <label class="form-label">Is Doubtful Taxon *</label>
