<x-layout bodyClass="g-sidenav-show bg-gray-200">
    <x-navbars.sidebar activePage="family"></x-navbars.sidebar>

    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <x-navbars.navs.auth titlePage="Create Family"></x-navbars.navs.auth>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div
                                ...
                                <h6 class="text-white text-capitalize ps-3 mb-0">Family Form</h6>
                                <a class="btn bg-gradient-dark mb-0 me-3" href="{{ route('family.index') }}">
