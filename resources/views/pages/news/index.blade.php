                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 mt-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">News & Updates</h6>
                            </div>
                        </div>

                        <div class=" me-3 my-3 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="{{ route('news.create') }}"><i
                                    ...
                                    <tbody>
                                        @forelse ($news as $index => $permission)
                                            <tr>
                                                ...
                                                <td class="text-uppercase text-secondary text-xxs font-weight-bolder">
                                                    <h6 class="mb-0 text-sm text-center">{{ $permission->title }}</h6>

                                                </td>
                                                <td class="text-uppercase text-secondary text-xxs font-weight-bolder">
                                                    <h6 class="mb-0 text-sm text-center">
                                                        <a href="{{  $permission->file_path }}"
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    <a class="btn btn-success btn-link"
                                                        href="{{ route('news.edit', $permission->id) }}">
                                                        <i class="material-icons">edit</i>
                                                    </a>

                                                    {{-- Delete Button --}}
                                                    <form action="{{ route('news.destroy', $permission->id) }}"
