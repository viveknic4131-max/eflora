        ...
        <section class="py-5 bg-light search-section">
            <div class="container">
                ...
                <div class="row g-2">
                    ...
                    @empty
                        <p class="text-center text-muted">No Genus found under this .</p>
                    @endforelse
                </div>

                <div class="mt-4">
                    {{ $genus->appends(request()->query())->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </section>
    @elseif($mode === 'checklist_genus')
        <section class="d-flex align-items-center text-white position-relative"
            style="background: url('{{ asset('images/breadcrumb.jpg') }}') center center / cover no-repeat; min-height: 300px;">
            <div class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-50"></div>
            <div class="container position-relative text-center py-5">
